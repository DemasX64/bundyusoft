...
import { addChar, clearQuery, setAnswer, setError } from '../../../services/reducers/calculator';
import { calculate, haveErrors } from '../../../utilds.js/calculator';
...
function Keypad() {
  ...
  return (
    <div className={keypad}>
      ...
      <KeyButton value=',' onClick={addCharHandle}/>
      <KeyButton value='=' isActive={answer?true:false} onClick={equalHandler}/>
    </div>
  )
}
